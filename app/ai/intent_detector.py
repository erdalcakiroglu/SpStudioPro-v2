...
class IntentDetector:
    ...
    def get_intent_description(self, intent: Intent) -> str:
        ...
        descriptions = {
            Intent.ANALYZE_QUERY: "Sorgu analizi yapılacak",
            Intent.EXPLAIN_PLAN: "Execution plan açıklanacak",
            Intent.OPTIMIZE_QUERY: "Sorgu optimizasyonu önerilecek",
            Intent.TOP_QUERIES: "En yoğun sorgular listelenecek",
            Intent.SLOW_QUERIES: "Yavaş sorgular gösterilecek",
            Intent.CPU_INTENSIVE: "CPU yoğun sorgular listelenecek",
            Intent.IO_INTENSIVE: "I/O yoğun sorgular listelenecek",
            Intent.TOP_WAITS: "Wait istatistikleri gösterilecek",
            Intent.WAIT_ANALYSIS: "Wait analizi yapılacak",
            Intent.BLOCKING_SESSIONS: "Blocking durumu kontrol edilecek",
            Intent.DEADLOCKS: "Deadlock bilgisi gösterilecek",
            Intent.MISSING_INDEXES: "Eksik index önerileri",
            Intent.UNUSED_INDEXES: "Kullanılmayan index'ler",
            Intent.INDEX_FRAGMENTATION: "Index fragmentasyonu kontrol edilecek",
            Intent.SERVER_STATUS: "Sunucu durumu özeti",
            Intent.MEMORY_STATUS: "Memory durumu gösterilecek",
            Intent.CPU_STATUS: "CPU durumu gösterilecek",
            Intent.DISK_STATUS: "Disk durumu gösterilecek",
            Intent.FAILED_JOBS: "Başarısız job'lar listelenecek",
            Intent.RUNNING_JOBS: "Çalışan job'lar listelenecek",
            Intent.SECURITY_AUDIT: "Güvenlik denetimi yapılacak",
            Intent.BACKUP_STATUS: "Backup durumu kontrol edilecek",
            Intent.LAST_BACKUP: "Son backup bilgisi",
            Intent.DATABASE_SIZE: "Veritabanı boyutu gösterilecek",
            Intent.TEMPDB_USAGE: "TempDB kullanımı gösterilecek",
            Intent.HELP: "Yardım bilgisi gösterilecek",
            Intent.GENERAL_QUESTION: "Genel soru cevaplanacak",
        }
        return descriptions.get(intent, "İşlem yapılacak")
